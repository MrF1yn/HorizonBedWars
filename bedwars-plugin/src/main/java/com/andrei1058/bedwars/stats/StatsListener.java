...
public class StatsListener implements Listener {
    ...
    public void onArenaLeave(PlayerLeaveArenaEvent event) {
        ...
        if(event.getArena().getStatus() != GameState.restarting){
            BedWars.debug("Winstreak set to 0 for player: "+playerStats.getName()+" because he left in the middle of the game.");
